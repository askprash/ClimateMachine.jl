...
function config_diagnostics(driver_config, boundaries, resolution)
    ...
    return ClimateMachine.DiagnosticsConfiguration([dgngrp_profiles, dgngrp_state])
end
...
function main()
    ...
    filter_vars = ("moisture.ρq_tot", "moisture.ρq_liq", "moisture.ρq_ice", "precipitation.ρq_rai", "precipitation.ρq_sno")
